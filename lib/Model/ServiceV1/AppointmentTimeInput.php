...
class AppointmentTimeInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AppointmentTimeInput';
     ...
     * Sets start_time
     *
     * @param string $start_time The date, time in UTC for the start time of an appointment in ISO 8601 format.
     *
     * @return self
     */
